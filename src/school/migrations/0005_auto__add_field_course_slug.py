...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('school_course', 'slug', self.gf('django.db.models.fields.SlugField')(default=0, max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.slug'
        db.delete_column('school_course', 'slug')
