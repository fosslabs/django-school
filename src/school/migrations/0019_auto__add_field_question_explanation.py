...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('school_question', 'explanation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.explanation'
        db.delete_column('school_question', 'explanation')
