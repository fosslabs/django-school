...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('school_assignment', 'max_points', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.max_points'
        db.delete_column('school_assignment', 'max_points')
