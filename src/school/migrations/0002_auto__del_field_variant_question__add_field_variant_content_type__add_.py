...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Variant.content_type'
        db.add_column('school_variant', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Variant.object_id'
        db.add_column('school_variant', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Variant.question'
        raise RuntimeError("Cannot reverse this migration. 'Variant.question' and its values cannot be restored.")
