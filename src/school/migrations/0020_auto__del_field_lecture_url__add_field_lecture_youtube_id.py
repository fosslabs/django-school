...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lecture.url'
        db.delete_column('school_lecture', 'url')

        # Adding field 'Lecture.youtube_id'
        db.add_column('school_lecture', 'youtube_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Lecture.url'
        raise RuntimeError("Cannot reverse this migration. 'Lecture.url' and its values cannot be restored.")

        # Deleting field 'Lecture.youtube_id'
        db.delete_column('school_lecture', 'youtube_id')
