...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attempt.student'
        db.alter_column('school_attempt', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Attempt.student'
        db.alter_column('school_attempt', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Student']))
