...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.prerequisite'
        db.add_column('school_assignment', 'prerequisite', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['school.LectureCategory']), keep_default=False)

        # Adding field 'LectureCategory.due'
        db.add_column('school_lecturecategory', 'due', self.gf('django.db.models.fields.DateTimeField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.prerequisite'
        db.delete_column('school_assignment', 'prerequisite_id')

        # Deleting field 'LectureCategory.due'
        db.delete_column('school_lecturecategory', 'due')
