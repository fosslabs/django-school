...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('school_lecturecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Course'])),
        ))
        db.send_create_signal('school', ['LectureCategory'])

        # Adding field 'Lecture.category'
        db.add_column('school_lecture', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['school.LectureCategory']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LectureCategory'
        db.delete_table('school_lecturecategory')

        # Deleting field 'Lecture.category'
        db.delete_column('school_lecture', 'category_id')
