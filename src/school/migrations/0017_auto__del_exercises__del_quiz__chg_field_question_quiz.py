...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.quiz'
        db.alter_column('school_question', 'quiz_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Assignment']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.quiz'
        db.alter_column('school_question', 'quiz_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Quiz']))
