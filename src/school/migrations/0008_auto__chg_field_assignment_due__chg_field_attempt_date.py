...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('school_assignment', 'due', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Attempt.date'
        db.alter_column('school_attempt', 'date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Assignment.due'
        db.alter_column('school_assignment', 'due', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Attempt.date'
        db.alter_column('school_attempt', 'date', self.gf('django.db.models.fields.DateField')())
