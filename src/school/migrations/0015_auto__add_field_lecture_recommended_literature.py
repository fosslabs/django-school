...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lecture.recommended_literature'
        db.add_column('school_lecture', 'recommended_literature', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lecture.recommended_literature'
        db.delete_column('school_lecture', 'recommended_literature')
