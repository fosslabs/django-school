...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('school_student', 'email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding unique constraint on 'Student', fields ['user']
        db.create_unique('school_student', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Student', fields ['user']
        db.delete_unique('school_student', ['user_id'])

        # Deleting field 'Student.email'
        db.delete_column('school_student', 'email')
